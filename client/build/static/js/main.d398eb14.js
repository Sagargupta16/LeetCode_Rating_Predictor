/*! For license information please see main.d398eb14.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      463: (e, n, t) => {
  ...
  (() => {
    ...
    const l = () => {
      const [n, t] = (0, e.useState)(""),
        ...
        [i, s] = (0, e.useState)(""),
        [c, f] = (0, e.useState)([]),
        [d, p] = (0, e.useState)(window.location.href),
        h = (0, e.useCallback)(async () => {
          try {
            const e = await fetch("".concat(d, "/api/contestData"), {
              method: "GET",
              headers: { "Content-Type": "application/json" },
            });
            if (!e.ok) throw new Error("HTTP error! status: ".concat(e.status));
            {
              const n = (await e.json()).contests.map((e) => ({
                name: e,
                rank: 0,
                include: !1,
              }));
      ...
      (0, e.useEffect)(() => {
        window.location.href.includes("localhost")
          ...
          : p("https://leetcode-rating-predictor.onrender.com"),
          h();
      }, [h]);
      return (0, r.jsxs)("div", {
        className: "PredictionComponent",
        children: [
          (0, r.jsx)("h1", { children: "Leetcode Rating Predictor" }),
          (0, r.jsxs)("form", {
            onSubmit: async (e) => {
              if ((e.preventDefault(), !n.trim()))
                return void s("Please enter a valid username.");
              const t = c.filter((e) => e.include && e.rank > 0);
              if (0 !== t.length) {
                u(!0), s(""), a([]);
                try {
                  const e = await fetch("".concat(d, "/api/predict"), {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ username: n, contests: t }),
                  });
                  if (e.ok) {
                    ...
                    s("Username does not exist or invalid data.");
                  }
                } catch (r) {
                  console.error(
                ...
                s("Please select at least one contest and enter your rank.");
            },
                    ...
                    children: [
                      (0, r.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, r.jsxs)("div", {
                            className: "input-title",
                            children: ["Participated in ", e.name, " ?"],
                          }),
                        ],
                      }),
                      (0, r.jsxs)("div", {
                        className: "input-title",
                        children: ["Your Rank in ", e.name],
                      }),
                      (0, r.jsx)("input", {
                        type: "number",
                        min: "1",
          ...
          (0, r.jsxs)("div", {
            ...
            children: [
                ...
                : l.map((e, n) =>
                    (0, r.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          (0, r.jsxs)("p", {
                            children: ["Contest: ", e.contest_name],
                          }),
                          (0, r.jsxs)("p", {
                            children: ["Your Rank: ", e.rank],
                          }),
                          (0, r.jsxs)("p", {
                            children: [
                              "Total Participants: ",
                          ...
                          (0, r.jsxs)("p", {
                            children: [
                              ...
                              e.rating_before_contest,
                            ],
                          }),
                          (0, r.jsxs)("p", {
                            children: [
                              "Rating Change: ",
                              e.rating_after_contest,
                            ],
                          }),
                          (0, r.jsxs)("p", {
                            children: [
                              ...
                              " ",
                              e.rating_before_contest + e.rating_after_contest,
                            ],
                          }),
                          (0, r.jsxs)("p", {
                            children: [
                              "Attended Contests Count: ",
                              e.attended_contests_count,
                            ],
                          }),
                        ],
                      },
              ...
              i && (0, r.jsx)("p", { className: "warning", children: i }),
            ],
          }),
        ],
      });
...
//# sourceMappingURL=main.d398eb14.js.map
